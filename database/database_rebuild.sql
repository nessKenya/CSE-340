---This code will be the start of a database rebuild file that you 
---can use to rebuild your entire database from scratch. 
---In future activities you will add additional SQL code 
---to this database rebuild file to create tables and add data.
